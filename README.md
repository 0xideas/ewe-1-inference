...
### Running Inference
To run the full pipeline and generate embeddings, simply execute the main script from the root of the repository:
...
1. Download the respective `.onnx` model into the `models/` folder.
2. Run `generate_embedding.py [MODEL_NAME]`.
